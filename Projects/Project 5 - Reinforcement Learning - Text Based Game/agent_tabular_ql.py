...
def epsilon_greedy(state_1, state_2, q_func, epsilon):
    ...
    if np.random.random() < epsilon:
        ...
        action_index, object_index = np.unravel_index(q_func[state_1, state_2, :, :].argmax(),
...
def tabular_q_learning(q_func, current_state_1, current_state_2, action_index,
    ...
    # TODO Your code here
    if terminal == False:
        action_index_after, object_index_after = np.unravel_index(q_func[next_state_1, next_state_2, :, :].argmax(), q_func[next_state_1, next_state_2].shape)
        q_func[current_state_1, current_state_2, action_index,
               ...
               object_index] + ALPHA * (reward + GAMMA * q_func[next_state_1, next_state_2, action_index_after, object_index_after])
    else:
        q_func[current_state_1, current_state_2, action_index,
               object_index] = (1- ALPHA) * q_func[current_state_1, current_state_2, action_index,
               object_index] + ALPHA * (reward)# TODO Your update here
