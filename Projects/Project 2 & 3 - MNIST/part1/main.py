...
def run_softmax_on_MNIST(temp_parameter=1):
    ...
    test_mod3_error = compute_test_error_mod3(test_x, test_y_mod3, theta, temp_parameter)

    return test_error, test_mod3_error


print('softmax test_error=, softmax test_error on mod3 =', run_softmax_on_MNIST(temp_parameter=1))
...
print("The test error of softmax regression trained on mod3 labels is: ", run_softmax_on_MNIST_mod3(temp_parameter=1))
...
print("The test error using principal component is:", run_softmax_on_MNIST_pca(temp_parameter=1))
...
def run_softmax_on_MNIST_general(train = train_x, test = test_x, temp_parameter=1):
    ...
    return test_error
print(run_softmax_on_MNIST_general(train_cube, test_cube, temp_parameter=1))
